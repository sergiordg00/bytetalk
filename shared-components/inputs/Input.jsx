...
export default function Input({ label, errors=[], ...inputProps }) {
  return ( 
    <div className="w-full">
      ...
      <input 
        className={clsx(
          "form-input mt-2 block w-full rounded-md border-0 bg-accentsecondary py-1.5 text-sm leading-6 text-textprimary shadow-sm ring-1 ring-inset ring-bordersecondary placeholder:text-textsecondary",
